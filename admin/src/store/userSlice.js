  ...
  async (item, thunkAPI) => {
    ...
    try {
      const res = await fetch(
        `http://localhost:8000/api/users/admin/${item}/unblock`,
        {
          method: "PATCH",
          headers: {
            "Content-type": "application/json; charset=UTF-8",
...
export const removeActive = createAsyncThunk(
  ...
  async (item, thunkAPI) => {
    ...
    try {
      const res = await fetch(
        `http://localhost:8000/api/users/admin/${item}/block`,
        {
          method: "PATCH",
          headers: {
            "Content-type": "application/json; charset=UTF-8",
...
export const removeAdmin = createAsyncThunk(
  ...
  async (item, thunkAPI) => {
    ...
    try {
      const res = await fetch(
        `http://localhost:8000/api/users/admin/${item}/removeadmin`,
        {
          method: "PATCH",
          headers: {
            "Content-type": "application/json; charset=UTF-8",
...
export const makeAdmin = createAsyncThunk(
  ...
  async (item, thunkAPI) => {
    ...
    try {
      const res = await fetch(
        `http://localhost:8000/api/users/admin/${item}/makeadmin`,
        {
          method: "PATCH",
          headers: {
            "Content-type": "application/json; charset=UTF-8",
...
export const updateUser = createAsyncThunk(
  ...
  async (item, thunkAPI) => {
    ...
    try {
      const res = await fetch(
        `http://localhost:8000/api/users/admin/${item[0]}`,
        {
          method: "PUT",
